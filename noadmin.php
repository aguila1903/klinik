...
<html>
  ...
  <body onload="preload()" vlink="#0000FF" class="noadmin_nm" id="noadmin">
    ...
    <div id="Panel1" style="background:url('bilder/titelBild.jpg') no-repeat transparent; width:1368px; height:794px; position:absolute; overflow:hidden; top:0px; left:0px; right:0px; margin-left:auto; margin-right:auto; ">
