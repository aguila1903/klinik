...
if ($ergebnis == -99) {
    $out['response']['status'] = -4;
    $out['response']['errors'] = array('prod_kz' => "Dieses Produkt-Kürzel existiert bereits. Bitte verwenden Sie ein anderes 4 stelliges Produkt-Kürzel");

    print json_encode($out);
    return;
} /*elseif ($ergebnis == -98) {
    $out['response']['status'] = -4;
    $out['response']['errors'] = array('prod_kz' => "Dieses Produkt-Kürzel wurde bereits verwendet, da es einen Eintrag in der Historie hat. Bitte verwenden Sie ein anderes 4 stelliges Produkt-Kürzel");
    ...
    If (isset($rs->fields['historie'])) {
        ...
        $out['response']['status'] = -4;
        $out['response']['errors'] = array('prod_kz' => "Keine Historie-Rückmeldung erhalten! Evtl. wurden die Änderungen nicht protokolliert. </br>" . utf8_encode($dbSyb->ErrorMsg()));
    ...
    $out['response']['status'] = -4;
    $out['response']['errors'] = array('prod_kz' => "Es ist ein unbekannter Fehler aufgetreten! Vorgang wird abgebrochen</br>" . utf8_encode($dbSyb->ErrorMsg()));
