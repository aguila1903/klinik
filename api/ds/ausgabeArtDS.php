...
if($vorgang == "ausgaben"){
    $sqlQuery = "select 'TÜM' as ausg_art_kz, 'TÜM' as bezeichnung
        union
        select ausg_art_kz, bezeichnung from ausgaben_arten";
}else{
$sqlQuery = "select ausg_art_kz, bezeichnung from ausgaben_arten";
}
