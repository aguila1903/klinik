...
if (isset($_REQUEST["menge"])) {
    ...
    $out{'response'}{'status'} = -1;
    $out{'response'}{'errors'} = array('nr' => "Die Menge fehlt!");
...
file_put_contents("editPosition.txt", $sqlQuery);
...
if ($ergebnis == -99) {
    ...
    $out{'response'}{'status'} = -4;
    $out{'response'}{'errors'} = array('prod_kz' => "Bitte generieren Sie eine neue Abrechnungsnummer oder passen Sie das Rechnungsdatum an.");
